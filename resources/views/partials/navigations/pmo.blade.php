    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              ...
              <a class="navs nav-link" href="{{ route('pr', ['status' => 'C']) }}"><i class="fas fa-check"></i>&nbsp Approved</a>
          </div>
      </li>
    </ul>
      <ul class="navbar-nav">
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                  <a class="navs nav-link" href="{{ route('nps') }}" aria-expanded="false"><i class="fas fa-plus"></i>&nbsp New</a>
                  <a class="navs nav-link" href="{{ route('pr', ['status' => 'C']) }}"><i class="fas fa-eye"></i>&nbsp View All</a>
              </div>
          </li>
      </ul>
    <!--
