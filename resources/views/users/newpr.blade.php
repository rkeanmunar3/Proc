                        ...
                        <div class="card" >
                            ...
                            <div class="card-body" style="background: #090038; height: 550px">
                                <div class="input-group mb-5">
                                    ...
                                    <input type="text" name="type" id="type" value="PR" class="form-control" disabled>
                        ...
                        <table class="table table-condensed table-sm table-hover table-striped text-white" id="inventoryTable">
                            ...
                            <tbody>
                               @foreach($itemlist as $item)
                                    <tr style="background: {{ ($item->stockbal < $item->standardstock) ? 'rgba(121, 3, 3, 0.8)' : '' }}">
                                        <td>{{ $item->codegrp }}</td>
                                        <td>{{ (int)$item->codegrp.'-'.$item->itemcode }}</td>
                                        <td>{{ $item->name }}</td>
                                        <td>
                                            {{ $item->description}}
                                        </td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                <div class="row float-right">
                                    ...
                                    &nbsp-->
                                    <a href="#" class="nav-link sendPR" data-prno="{{ $prno }}" id="sendPR">SEND <i class="fas fa-paper-plane" id="icon"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script src="{{ asset('js/pharmacy/newpr.js') }}"></script>
@endpush